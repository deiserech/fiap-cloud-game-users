...
{
    public class GameConsumerTests
    {
        [Fact]
        public async Task ExecuteAsync_RegisterHandlers_And_StartsProcessor()
        {
            ...
            mockClient.Verify(c => c.CreateProcessorWrapper("games-created-updated", "fiap-cloud-games-users", It.IsAny<ServiceBusProcessorOptions?>()), Times.Once);
